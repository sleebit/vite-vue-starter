<template>
  <div class="flex flex-col gap-6 h-screen">
    <Card class="overflow-hidden w-[50%] m-auto">
          ...
          <div class="flex flex-col gap-6">
            ...
            <div class="grid grid-cols-3 gap-4">
              <Button variant="outline" class="w-full">
                ...
                <span class="sr-only">Signup with Apple</span>
              </Button>
              <Button variant="outline" class="w-full">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path
                ...
                <span class="sr-only">Signup with Google</span>
              </Button>
              <Button variant="outline" class="w-full">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                  <path
                ...
                <span class="sr-only">Signup with Meta</span>
              </Button>
            </div>
            <div class="text-center text-sm">
...
export default {
    ...
    "$route.params.type": {
      handler() {
        if (this.$route?.params?.type) {
          this.authType = this.$route?.params?.type?.toUpperCase();
        }
      },
    },
  },
  mounted() {
    ...
    if (this.$route.path == "/login") {
      this.$store.commit("SET_SHOW_LOGIN_POPUP", true);
      if (window.history.length - this.$route.historyCount) {
        this.$router.back();
      } else {
        this.$router.push("/");
      }
